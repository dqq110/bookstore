    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='支付方式', default=1, choices=[(1, '货到付款'), (2, '微信支付'), (2, '支付宝'), (2, '银联支付')])),
                ...
                ('addr', models.ForeignKey(verbose_name='收获地址', to='users.Address')),
